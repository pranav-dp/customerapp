    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.content}>
        ...
        <View style={styles.heroSection}>
          ...
          <Text style={styles.title}>Good things ahead</Text>
        ...
        <View style={styles.features}>
          <View style={styles.featureItem}>
            ...
            <Text style={styles.featureText}>Skip the queue</Text>
          </View>
          <View style={styles.featureItem}>
            <Ionicons name="phone-portrait" size={28} color={colors.primary} />
            <Text style={styles.featureText}>Order from class</Text>
          </View>
          <View style={styles.featureItem}>
            <Ionicons name="notifications" size={28} color={colors.primary} />
            <Text style={styles.featureText}>Get notified</Text>
          </View>
        </View>
      </View>
